...
class AdmisScreen extends StatefulWidget {
  const AdmisScreen({Key? key}) : super(key: key);

  @override
  _AdmisScreenState createState() => _AdmisScreenState();
}

class _AdmisScreenState extends State<AdmisScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            title: const Text("Candidats admis"),
                  ...
                  children: values!
                      .map(
                        (AirtableDataCandidate value) => BannerListTile(
                          ...
                          bannerColor: Color.fromARGB(255, 47, 180, 47),
                          backgroundColor: Color.fromARGB(255, 48, 118, 146),
